...
?>
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30 col-md-8">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Form Topup Saldo Member</h4>
							<p class="mb-30 font-14"></p>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" placeholder="HDSN" name="username" id="username" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
...
post();
	...
	var saldo = $('#saldo').val();
	$.ajax({
		url	: 'proses/topupsaldomember().php',
