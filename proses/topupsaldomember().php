...
<?php
  ...
  $cekuser = mysql_query("SELECT * FROM member WHERE username = '$username1'");  
...
<? } else {
 $simpan = mysql_query("UPDATE member SET saldo=saldo+$jumlah WHERE username = '$username1'");
 $simpan = mysql_query("UPDATE user SET saldo=saldo-$jumlah WHERE username = '$username'");
 if($simpan) { ?>
<div class="alert alert-success"><center>
====[ TopUp Saldo ]====<br />
TopUp Saldo sukses!<br />
Nama Penerima : <?php echo $data['name']; ?> <br />
